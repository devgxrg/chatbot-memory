                  ...
                  >
                    ...
                    <div className={`flex-1 max-w-2xl ${
                      ...
                      <div className={`inline-block p-4 rounded-2xl shadow-sm transition-all duration-200 hover:shadow-md ${
                        ...
                        {/* Message content */}
                        <div className={message.sender === 'user' ? 'text-white' : 'prose prose-sm max-w-none'}>
                          <ReactMarkdown 
                            ...
                            components={{
                              ...
                              th: ({children}) => (
                                <th className="px-4 py-3 text-left font-semibold border-r border-gray-200 last:border-r-0">
                                  {children}
                                </th>
                              ),
                              td: ({children}) => (
                        ...
                        {/* Context indicator with View Sources button */}
                        {message.hasContext && message.source_references && message.source_references.length > 0 && (
                          <div className="mt-3 pt-3 border-t border-purple-200/50">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2 text-xs text-purple-700 bg-purple-50 px-3 py-1.5 rounded-full">
                                <FileText className="w-3 h-3" />
                                <span>Enhanced with document context</span>
                              </div>
                              
                              <button
                                onClick={() => toggleReferences(message.id)}
                                className="flex items-center gap-1 text-xs text-purple-600 hover:text-purple-800 hover:bg-purple-100 px-2 py-1 rounded-full transition-colors"
                              >
                      ...
                      {showReferences[message.id] && message.source_references && message.source_references.length > 0 && (
                        <div className="mt-3 p-4 bg-gray-50 border border-gray-200 rounded-xl shadow-sm">
                          <div className="flex items-center justify-between mb-3">
                            <h4 className="font-semibold text-gray-800 flex items-center gap-2">
                              <FileText className="w-4 h-4" />
                              Sources Used ({message.source_references.length})
                            </h4>
                            <button
                              onClick={() => toggleReferences(message.id)}
                          ...
                          <div className="mt-3 p-2 bg-blue-50 rounded text-xs text-blue-700">
                            These sections from your document were used to generate this response.
                          </div>
                        </div>
                      )}
